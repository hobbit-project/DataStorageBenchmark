...
#docker build -f docker/virtuosocomsystem.docker -t git.project-hobbit.eu:4567/mspasic/virtuosocomsystem .
...
#docker push git.project-hobbit.eu:4567/mspasic/virtuosocomsystem
